            ...
            */
            ...
            {"PushIt", (Action)(async () => {
                try
                {
                    ...
                    string APPLICATION_API_TOKEN = ""; // Generated at https://pushover.net/apps/build
                    string USER_KEY = ""; // Found on your dashboard at https://pushover.net
                    string MESSAGE = "You Have Been Pushed!"; // Or whatever you wish to send
